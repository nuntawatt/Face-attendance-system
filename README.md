# Face Attendance System - ระบบบันทึกเวลาทเข้างานด้วยใบหน้า  🎭

ระบบหลังบ้าน สำหรับบันทึกเวลาเข้า-ออกงานด้วยใบหน้าแบบ Realtime พัฒนาด้วย FastAPI ควบคู่กับโมเดล AI InsightFace สำหรับตรวจจับและจำแนกใบหน้า พร้อมระบบจัดเก็บไฟล์รูปภาพใบหน้าใน MinIO Object Storage และรองรับการทำ Soft Delete เพื่อความปลอดภัยของข้อมูล
